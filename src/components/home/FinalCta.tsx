      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900/40 via-slate-800/30 to-slate-700/40 supports-[backdrop-filter]:backdrop-blur-md supports-[backdrop-filter]:backdrop-saturate-150 ring-1 ring-white/20 shadow-[0_18px_60px_-20px_rgba(77,175,254,0.35)]">
        ...
        <div className="relative p-8 md:p-12 lg:p-16">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="heading text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 bg-[#C30003] bg-clip-text text-transparent leading-tight drop-shadow-[0_1px_8px_rgba(2,241,255,0.18)]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                asChild
                variant="hero"
                className="group h-14 px-8 text-lg shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
              >
